    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "german_name",
                    models.CharField(max_length=255, verbose_name="German name"),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        ...
                        verbose_name="address of bioengineering facility",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        max_length=255,
                        verbose_name="name of the biosafety officer",
                    ),
                ),
                (
                    "s1_approval_file_num",
                    models.CharField(
                        help_text="e.g. 21-29,8 B 56.01; TgbNr.: 8/29,0/11/36",
                        max_length=255,
                        verbose_name="file number for S1 approval",
                    ),
                ),
                (
                    "s1_approval_date",
                    models.DateField(null=True, verbose_name="S1 approval date"),
                ),
                (
                    "s2_approval_file_num",
                    models.CharField(
                        help_text="e.g. 29,8 B 56.02:21; TgbNr.: 8/29,0/13/46",
                        max_length=255,
                        verbose_name="file number for S2 approval",
                    ),
                ),
                (
                    "s2_approval_date",
                    models.DateField(null=True, verbose_name="S2 approval date"),
                ),
            ],
            options={
                "verbose_name": "header",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="<i>Titel</i>", max_length=255, verbose_name="title"
                    ),
                ),
                (
                    "short_title",
                    models.CharField(
                        help_text="<i>Kurzer Titel</i>",
                        max_length=255,
                ...
                (
                    "short_title_english",
                    models.CharField(
                        max_length=255, verbose_name="English short title"
                    ),
                ),
                (
                    "safety_level",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=255,
                        verbose_name="objectives of strategy",
                    ),
                ),
                (
                    "description",
                    models.TextField(
                        blank=True,
                        help_text="Techniques, organisms, plasmids, etc. <i>Beschreibung der Durchführung</i>",
                        verbose_name="Description of strategy/performance",
                    ),
                ),
                (
                    "donor_organims",
                    models.CharField(
                        blank=True,
                        help_text="Used organisms, their risk group and safety-relevant properties. <i>Verwendete Spenderorganismen</i>",
                        max_length=255,
                        verbose_name="donor organisms",
                    ),
                ),
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Include safety-relevant properties. <i>Gefährdungspotentiale der übertragenen Nukleinsäuren</i>",
                        verbose_name="potential risks of transferred nucleic acids",
                    ),
                ),
                (
                    "vectors",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Include risk groups and safety-relevant properties. <i>Verwendete Empfängerorganismen</i>",
                        max_length=255,
                        verbose_name="recipient organisms",
                    ),
                ),
                (
                    "generated_gmo",
                    models.TextField(
                        blank=True,
                        help_text="Include risk groups and safety-relevant properties. <i>Erzeugte GVO</i>",
                        verbose_name="generated GMOs",
                    ),
                ),
                (
                    "hazard_activity",
                    models.TextField(
                        ...
                        verbose_name="hazard-relevant characteristics of activity",
                    ),
                ),
                (
                    "hazards_employee",
                    models.TextField(
                        blank=True,
                        help_text="<i>Schwere und Wahrscheinlichkeit einer Gefährdung der Mitarbeiter und/oder der Umwelt</i>",
                        verbose_name="severity and likelihood of hazards to employees and/or the environment",
                    ),
                ),
                (
                    "beginning_work_date",
                    models.DateField(
                        ...
                        null=True,
                        verbose_name="beginning of work",
                    ),
                ),
                (
                    "end_work_date",
                    models.DateField(
                        blank=True,
                        help_text="<i>Ende der Arbeiten</i>",
                        null=True,
                        verbose_name="end of work",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        max_length=255,
                        verbose_name="classification of genetic work",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="This is only the name displayed in the rendered FormZ form. It is NOT used for auto-detection of features in a plasmid map, only aliases (below) are used for that. Duplicates are allowed, therefore, instead of using, for example, 'Hs EXO1', use 'EXO1'",
                        max_length=255,
                        verbose_name="name",
                    ),
                ),
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        verbose_name="is this a common plasmid feature?",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "common_name",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="common name"
                    ),
                ),
                (
                    "risk_group",
                ...
                (
                    "show_in_cell_line_collection",
                    models.BooleanField(
                        default=False,
                        verbose_name="show as organism in cell line collection?",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "synonym",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="synonym"
                    ),
                ),
                ("organism", models.CharField(max_length=255, verbose_name="organism")),
                (
                    "risk_potential",
                    models.CharField(max_length=255, verbose_name="risk potential"),
                ),
                ...
                (
                    ...
                    models.BooleanField(
                        blank=True, verbose_name="genetically modified?"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "additional_measures",
                    models.BooleanField(
                        blank=True, verbose_name="additional measures?"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "label",
                    models.CharField(
                        blank=True, max_length=255, unique=True, verbose_name="alias"
                    ),
                ),
                (
                    "sequence_feature",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "beginning_work_date",
                    models.DateField(
                        blank=True, null=True, verbose_name="beginning of work"
                    ),
                ),
                (
                    "end_work_date",
                    models.DateField(blank=True, null=True, verbose_name="end of work"),
                ),
                (
                    "formz_project",
                    models.ForeignKey(
